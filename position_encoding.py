...
def build_position_encoding(cfg):
    N_steps = cfg['model']['params']['hidden_dim']// 2
    downsample_ratio = 32

    if cfg['model']['params']['position_embedding'] in ('v2', 'sine'):
        # TODO find a better way of exposing other arguments
        assert cfg['data']['imgsize'][0] % 32 == 0, "cfg['data']['imgsize'][0] ({}) % 32 != 0".format(cfg['data']['imgsize'])
        position_embedding = PositionEmbeddingSine(N_steps, normalize=True, maxH=cfg['data']['imgsize'][0] // downsample_ratio, maxW=cfg['data']['imgsize'][1] // downsample_ratio)
